...
if ! [ -f ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl31_v1.25.elf ]; then
	echo "File ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl31_v1.25.elf is absent."
	exit -1
fi

cp ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl31_v1.25.elf ${BUILD_DIR}/uboot-${UBOOT_REPO}/bl31.elf

if ! [ -f ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl32_v1.10.bin ]; then
	echo "File ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl32_v1.10.bin is absent."
	exit -1
fi

cp ${BUILD_DIR}/rkbin/bin/rk35/rk3588_bl32_v1.10.bin ${BUILD_DIR}/uboot-${UBOOT_REPO}/tee.bin
